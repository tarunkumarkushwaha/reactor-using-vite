...
const ToolsPage = () => {
  ...
  return (
    <div className="bg-gradient-to-b from-white to-blue-300 min-h-screen w-full smooth-entry">
      <div className="relative p-5 flex justify-center items-center" ref={inputRef}>
        ...
        {showDropdown && (
          <div className="absolute top-16 w-80 overflow-scroll overflow-x-hidden z-10 mt-1 bg-white border border-gray-300 rounded shadow-lg">
